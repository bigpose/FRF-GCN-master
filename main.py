...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='./config/nturgbd-cross-view/test_joint_bone.yaml',
...
class Processor():
    ...
    def load_optimizer(self):
        ...
        # lr_scheduler_pre = optim.lr_scheduler.CosineAnnealingLR(
        #     self.optimizer, T_max=self.arg.epochs, eta_min=0)
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        # plt.xlabel('iter_num')
        # plt.legend()
        # plt.savefig(os.path.join('graph', "test_loss.jpg"))
